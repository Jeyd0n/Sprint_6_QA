...
class YaScooterOrderPage(BasePage):
    ...
    def choose_subway(
        ...
        return self.find_element(
            Locators.SUBWAY_HINT_BUTTON(subway_name)
        ).click()
    ...
    def fill_user_data(
        ...
        self.choose_subway(
            data_set['subway_name']
        )
        self.input_telephone_number(
            data_set['telepthone_number']
        )
